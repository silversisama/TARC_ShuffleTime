...
const u8 gText_ST[] = _(" ST");
const u8 gText_YouDontHaveST[] = _("You don't have enough Sword Tokens.{PAUSE_UNTIL_PRESS}");
const u8 gText_YouWantedVar1ThatllBeVar2_ST[] = _("You wanted {STR_VAR_1}?\nThat'll be {STR_VAR_2} ST. Will that be okay?");
const u8 gText_Var1AndYouWantedVar2_ST[] = _("{STR_VAR_1}? And you wanted {STR_VAR_2}?\nThat will be {STR_VAR_3} ST.");
const u8 gText_YouWantedVar1ThatllBeVar2_STMove[] = _("The move {STR_VAR_1}, is it?\nThat will be {STR_VAR_2} ST.");
