...
static const struct MonChoiceData sStarterChoices[9] = 
{
    ...
    [BALL_MIDDLE_FIRST]     = {SPECIES_DARKRAI, 30, ITEM_NONE, 0, NATURE_NEUTRAL, 0, MON_GENDERLESS, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, { MOVE_DARK_PULSE, MOVE_SHADOW_BALL, MOVE_NASTY_PLOT, MOVE_REST}},
