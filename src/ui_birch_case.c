...
{
    [BALL_TOP_FIRST]        = {SPECIES_SUICUNE, 30, ITEM_NONE, 0, NATURE_MODEST, 0, MON_GENDERLESS, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, { MOVE_WATER_PULSE, MOVE_CALM_MIND, MOVE_ICE_BEAM, MOVE_SUBSTITUTE}},
    [BALL_TOP_SECOND]       = {SPECIES_VICTINI, 30, ITEM_NONE, 0, NATURE_JOLLY, 0, MON_GENDERLESS, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, { MOVE_V_CREATE, MOVE_STORED_POWER, MOVE_WORK_UP, MOVE_U_TURN}},
    [BALL_MIDDLE_FIRST]     = {SPECIES_DARKRAI, 30, ITEM_NONE, 0, NATURE_SERIOUS, 0, MON_GENDERLESS, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, { MOVE_DARK_PULSE, MOVE_SHADOW_BALL, MOVE_NASTY_PLOT, MOVE_REST}},

    [BALL_TOP_THIRD]        = {SPECIES_MELOETTA, 30, ITEM_NONE, 0, NATURE_NAIVE, 0, MON_GENDERLESS, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, { MOVE_RELIC_SONG, MOVE_CLOSE_COMBAT, MOVE_TEETER_DANCE, MOVE_ACROBATICS}},
    [BALL_TOP_FOURTH]       = {SPECIES_VIRIZION, 30, ITEM_NONE, 0, NATURE_MODEST, 0, MON_GENDERLESS, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_GIGA_DRAIN, MOVE_CALM_MIND, MOVE_AURA_SPHERE, MOVE_PROTECT}},
    [BALL_MIDDLE_THIRD]     = {SPECIES_HOOPA, 30, ITEM_NONE, 0, NATURE_JOLLY, 0, MON_GENDERLESS, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_PHANTOM_FORCE, MOVE_CALM_MIND, MOVE_PSYSHOCK, MOVE_TRICK}},

    [BALL_MIDDLE_SECOND]    = {SPECIES_RAIKOU, 30, ITEM_NONE, 0, NATURE_TIMID, 0, MON_GENDERLESS, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_VOLT_SWITCH, MOVE_CALM_MIND, MOVE_THUNDERBOLT, MOVE_SUBSTITUTE}},
    [BALL_BOTTOM_FIRST]     = {SPECIES_MAGEARNA, 30, ITEM_NONE, 0, NATURE_MODEST, 0, MON_GENDERLESS, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_PSYBEAM, MOVE_FLASH_CANNON, MOVE_SUBSTITUTE, MOVE_DAZZLING_GLEAM}},
    [BALL_BOTTOM_SECOND]    = {SPECIES_DIANCIE, 30, ITEM_NONE, 0, NATURE_CALM, 0, MON_GENDERLESS, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_DRAINING_KISS, MOVE_CALM_MIND, MOVE_ANCIENT_POWER, MOVE_PROTECT}},
};
