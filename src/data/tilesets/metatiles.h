...
const u16 gMetatiles_TARC[] = INCBIN_U16("data/tilesets/primary/tarc/metatiles.bin");
const u16 gMetatileAttributes_TARC[] = INCBIN_U16("data/tilesets/primary/tarc/metatile_attributes.bin");
